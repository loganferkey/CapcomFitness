        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeightHistory_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseExerciseType", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseExerciseType_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseExerciseType_ExerciseTypes_ExerciseTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteRoutines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserFavoriteRoutines_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteRoutines_Routines_RoutineId",
                        column: x => x.RoutineId,
                        principalTable: "Routines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseExerciseType_ExerciseId",
                table: "ExerciseExerciseType",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_ExerciseExerciseType_ExerciseTypeId",
                table: "ExerciseExerciseType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteRoutines_RoutineId",
                table: "UserFavoriteRoutines",
                column: "RoutineId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteRoutines_UserId",
                table: "UserFavoriteRoutines",
                column: "UserId");
